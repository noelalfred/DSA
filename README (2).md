...
|3.|Write a C program to roll_no, name , percentange of 5 students using array of structure and display the records in ascending order of roll list.|[Asc_rollno.c.txt](https://github.com/noelalfred/DSA/blob/main/Asc_rollno.c.txt)|
